...
const ScholarshipHelpPage = ({ file: uploadedFile }) => {
    const steps = [
      ...
      {
          id: "3",
          message: "Please provide the URL to the scholarship you are applying too for an cover letter style essay recommending you for the scholarship given the attached resume or document!",
          trigger: 'url'
      },
